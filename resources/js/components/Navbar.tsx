...
export default function Navbar() {
    return (
        <nav className="border-2 flex items-center border-md-outline font-semibold sticky top-0 bg-md-background">
            ...
            <div className="space-x-12 mx-8">
                ...
                <Link href="/about" className='text-md-on-primary-container'>Về chúng tôi</Link>
